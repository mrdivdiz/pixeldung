...
import com.tsh.utils.SystemTime;
...
public enum Rankings {
	...
	public static class Record implements Bundlable {
		...
		private static final String THEME1	= "THEME";
		private static final String THEME2	= "THEME";
		...
		public void restoreFromBundle( Bundle bundle ) {
			...
			Theme.bull = bundle.getBoolean(THEME1);
			Theme.bull2 = bundle.getBoolean(THEME2);
