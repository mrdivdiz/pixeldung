...
public class FlyingRobtSniper extends Mob {
	...
	public String description() {
		return
			...
			+ "This is a flying enraged killing machine with rocket launcher, upgraded with laser autoaim.I think it more accurate that chainsaws or normal rocket launcher.Version " + Mob.generation_robot + " of generation." ;
	}
}
