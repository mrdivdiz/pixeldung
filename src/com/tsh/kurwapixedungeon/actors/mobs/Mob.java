...
import com.tsh.kurwapixedungeon.effects.Wound;
...
public abstract class Mob extends Char {
	...
	public static int generation_robot = 0;
	public String robgen = "robgen";
	
	@Override
	public void storeInBundle( Bundle bundle ) {
		
		super.storeInBundle( bundle );
		bundle.put(robgen, generation_robot);
		if (state == SLEEPEING) {
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		generation_robot = bundle.getInt(robgen);
	...
	private class Sleeping implements AiState {
		...
		@Override
		public String status() {
			return Utils.format( "HP:" + HP + ".This %s is sleeping", name );
		}
	}
	...
	private class Wandering implements AiState {
		...
		@Override
		public String status() {
			return Utils.format( "HP:" + HP + ".This %s is wandering", name );
		}
	}
	...
	private class Hunting implements AiState {
		...
		@Override
		public String status() {
			return Utils.format( "HP:" + HP + ".This %s is hunting", name );
		}
	}
	...
	protected class Fleeing implements AiState {
		...
		@Override
		public String status() {
			return Utils.format( "HP:" + HP + ".This %s is fleeing", name );
		}
	}
	...
	private class Passive implements AiState {
		...
		@Override
		public String status() {
			return Utils.format( "HP:" + HP + ".This %s is passive", name );
		}
	}
}
