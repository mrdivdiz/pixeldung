...
public class FlyingRobtSniperHD extends Mob {

	{
		name = "Flying rocket-upgraded robt with armored shield";
		spriteClass = RobtSprite.class;
		
		HP = HT = 495 + (Mob.generation_robot * 15);
		defenseSkill = 15 + Hero.defenseSkill * 3;
	...
	public int damageRoll() {
		return Random.NormalIntRange( 12, Hero.attackSkill * 2 );
	}
	...
	public String description() {
		return
			...
			+ "This is a flying enraged killing machine with rocket launcher, upgraded with laser autoaim."
			+ "I think it more accurate that chainsaws or normal rocket launcher.And there are additional armor too."
			+ "Version " + Mob.generation_robot + " of generation." ;
	}
}
