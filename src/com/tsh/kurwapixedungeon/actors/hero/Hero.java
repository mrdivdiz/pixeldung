...
import com.tsh.kurwapixedungeon.Bones;
import com.tsh.kurwapixedungeon.Dungeon;
import com.tsh.kurwapixedungeon.GamesInProgress;
...
import com.tsh.kurwapixedungeon.actors.buffs.Blindness;
import com.tsh.kurwapixedungeon.actors.buffs.Buff;
import com.tsh.kurwapixedungeon.actors.buffs.Burning;
import com.tsh.kurwapixedungeon.actors.buffs.Charm;
import com.tsh.kurwapixedungeon.actors.buffs.Combo;
import com.tsh.kurwapixedungeon.actors.buffs.Cripple;
import com.tsh.kurwapixedungeon.actors.buffs.Fury;
import com.tsh.kurwapixedungeon.actors.buffs.GasesImmunity;
...
import com.tsh.kurwapixedungeon.actors.buffs.Ooze;
import com.tsh.kurwapixedungeon.actors.buffs.Paralysis;
import com.tsh.kurwapixedungeon.actors.buffs.Poison;
import com.tsh.kurwapixedungeon.actors.buffs.Regeneration;
...
import com.tsh.kurwapixedungeon.effects.CheckedCell;
...
import com.tsh.kurwapixedungeon.items.Ankh;
...
import com.tsh.kurwapixedungeon.items.KindOfWeapon;
...
import com.tsh.kurwapixedungeon.items.rings.RingOfAccuracy;
import com.tsh.kurwapixedungeon.items.rings.RingOfDetection;
import com.tsh.kurwapixedungeon.items.rings.RingOfElements;
import com.tsh.kurwapixedungeon.items.rings.RingOfEvasion;
import com.tsh.kurwapixedungeon.items.rings.RingOfHaste;
...
import com.tsh.kurwapixedungeon.items.scrolls.ScrollOfRecharging;
...
import com.tsh.kurwapixedungeon.items.weapon.shooting.ShootingWeapon;
import com.tsh.kurwapixedungeon.levels.Level;
import com.tsh.kurwapixedungeon.levels.Terrain;
import com.tsh.kurwapixedungeon.levels.features.AlchemyPot;
import com.tsh.kurwapixedungeon.levels.features.Chasm;
import com.tsh.kurwapixedungeon.levels.features.Sign;
import com.tsh.kurwapixedungeon.plants.Earthroot;
import com.tsh.kurwapixedungeon.scenes.GameScene;
import com.tsh.kurwapixedungeon.scenes.InterlevelScene;
import com.tsh.kurwapixedungeon.scenes.SurfaceScene;
import com.tsh.kurwapixedungeon.sprites.CharSprite;
import com.tsh.kurwapixedungeon.sprites.HeroSprite;
import com.tsh.kurwapixedungeon.ui.AttackIndicator;
...
import com.tsh.kurwapixedungeon.windows.WndResurrect;
import com.tsh.kurwapixedungeon.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	public static int skillhp = 0;
	public static int defskill = 0;
	public static int attackSkill = 10;
	public static int defenseSkill = 5;
	public static int sp = 0;
	public static int mana = 0;
	public static int manat = 100;
	...
	public boolean restoreMana = false;
	
	public MissileWeapon rangedWeapon = null;
	public ShootingWeapon rangedWeapon2 = null;
	...
	private static final String skillpoints	= "skill_points";
	private static final String skillhpp	= "skill_hp";
	private static final String skilldefp	= "skill_def";
	...
	public void storeInBundle( Bundle bundle ) {
		...
		bundle.put(skillpoints, sp);
		bundle.put(skillhpp, skillhp);
		bundle.put(skilldefp, defskill);
		bundle.put( ATTACK, attackSkill - skillhp);
		bundle.put( DEFENSE, defenseSkill - defskill);
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		skillhp = bundle.getInt(skillhpp);
		defskill = bundle.getInt(skilldefp);
		mana = bundle.getInt( MANA );if(mana > manat){mana = manat;}
		attackSkill = bundle.getInt( ATTACK) + skillhp;
		defenseSkill = bundle.getInt( DEFENSE) + defskill;
		
		sp = bundle.getInt(skillpoints);
...
public boolean shoot2( Char enemy, ShootingWeapon shootingWeapon ) {
		
		rangedWeapon2 = shootingWeapon;
		boolean result = attack( enemy );
		rangedWeapon = null;
	...
	public void earnExp( int exp ) {
		...
		if (levelUp) {
			...
			GLog.p("You earned a new SkillPoint!");
	...
	public void add( Buff buff ) {
		...
		if (sprite != null) {
			if (buff instanceof Burning) {
				...
				GLog.w( "You become furious!Holy shit!" );
				sprite.showStatus( CharSprite.POSITIVE, "furious" );
			} else if (buff instanceof Charm) {
				GLog.w( "You are charmed!Do not record porn videos in there!" );
			}  else if (buff instanceof Cripple) {
				GLog.w( "You are crippled!" );
			} else if (buff instanceof Bleeding) {
				GLog.w( "You are bleeding!" );
			} else if (buff instanceof Vertigo) {
				GLog.p( "YOU SPIN ME ROUND RIGHT BABY RIGHT ROUND LIKE A RECORD BABY ROUND, ROUND, ROUND, ROUND!" );
				interrupt();
			}
