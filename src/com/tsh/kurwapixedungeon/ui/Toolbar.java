...
import com.tsh.kurwapixedungeon.scenes.AmuletScene;
...
import com.tsh.kurwapixedungeon.windows.WndCatalogus;
import com.tsh.kurwapixedungeon.windows.WndCraft;
import com.tsh.kurwapixedungeon.windows.WndGuide;
import com.tsh.kurwapixedungeon.windows.WndHero;
import com.tsh.kurwapixedungeon.windows.WndInfoCell;
import com.tsh.kurwapixedungeon.windows.WndInfoItem;
import com.tsh.kurwapixedungeon.windows.WndInfoMob;
import com.tsh.kurwapixedungeon.windows.WndInfoPlant;
...
public class Toolbar extends Component {
	...
	private Tool btnGuide;
	private Tool btnBase;
	private Tool btnWait;
	private Tool btnCraft;
	...
	protected void createChildren() {
		add( btnCraft = new Tool(105, 7, 20, 25){
		@Override
		protected void onClick() {
			
			GameScene.show(new WndCraft());
		}
		});
		
		add( btnGuide = new Tool(0, 39, 20, 25){
			@Override
			protected void onClick() {
				try {
					Dungeon.saveAll();
		...
		add( btnBase = new Tool(20, 39, 20, 25){
			@Override
			protected void onClick() {
				GameScene.show(new WndBase());
			};
		});
	...
	@Override
	protected void layout() {
		btnGuide.setPos(x, y - btnWait.height());
		btnBase.setPos(2, 40);
		btnWait.setPos( x, y );
		btnSearch.setPos( btnWait.right(), y );
		btnInfo.setPos( btnSearch.right(), y );
		btnCraft.setPos(btnInfo.right(), y);
