...
public class AdditionalItemSprite extends MovieClip {
	...
	public AdditionalItemSprite() {
		this( ItemSpriteSheet.SMTH, null );
	}
	
	public AdditionalItemSprite( Item item ) {
		this( item.image(), item.glowings() );
	}
	
	public AdditionalItemSprite( int image, Glowing glowing2 ) {
		super( Assets.ITEMS );
	...
	public AdditionalItemSprite view( int image, Glowing glowing ) {
