...
public class ItemSpriteSheet {
	...
	public static final int SEED_WEED	= 151;
	...
	public static final int AMMO	= 137;
	...
	public static final int CARPACCIO	= 119;
	
	// Bags
	public static final int POUCH	    = 83;
	public static final int POUCHEAT	= 131;
	public static final int POUCHTRASH	= 138;
	...
	// Misc
	public static final int ISOLATION	= 132;
	...
	public static final int HAMBURGER_S = 116;
	public static final int CAN = 139;
	public static final int BOX = 140;
	public static final int BOOT = 141;
	public static final int SAW = 143;
	public static final int INCH = 142;
	public static final int VODKA = 144;
	public static final int BEER = 133;
	public static final int ARMOR_DIRT = 128;
	public static final int ARMOR_2DIRT = 145;
	public static final int PURESHKA = 146;
	public static final int BLIN = 147;
	public static final int HAMBURGER_C = 129;
	public static final int PIZZA = 130;
	public static final int SEED_DEWCATCHER = 134;
	public static final int REDDEWDROP = 135;
	public static final int LIMEDEWDROP = 148;
	public static final int ORANGEDEWDROP = 149;
	public static final int GAYPORN = 150;
	public static final int AWP = 136;
	public static final int SEM = 152;
	public static final int RICESEM = 153;
	public static final int RICEBALL = 154;
	public static final int RICEBOMB = 155;
	public static final int PIXELGUN = 156;
	public static final int UNLOCKER = 157;
	public static final int MANAPOT = 158;
	//max is 158;
}
