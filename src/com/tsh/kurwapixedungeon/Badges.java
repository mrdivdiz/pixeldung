...
import com.tsh.kurwapixedungeon.actors.mobs.Acidic;
import com.tsh.kurwapixedungeon.actors.mobs.Albino;
import com.tsh.kurwapixedungeon.actors.mobs.Bandit;
import com.tsh.kurwapixedungeon.actors.mobs.Mob;
import com.tsh.kurwapixedungeon.actors.mobs.Senior;
import com.tsh.kurwapixedungeon.actors.mobs.Shielded;
...
import com.tsh.kurwapixedungeon.items.bags.WandHolster;
import com.tsh.kurwapixedungeon.items.potions.Potion;
import com.tsh.kurwapixedungeon.items.rings.Ring;
import com.tsh.kurwapixedungeon.items.rings.RingOfHaggler;
...
public class Badges {
	...
	public static enum Badge {
		MONSTERS_SLAIN_1( "10 cocksuckers slain", 0 ),
		MONSTERS_SLAIN_2( "50 motherfuckers slain", 1 ),
		MONSTERS_SLAIN_3( "150 bitches slain", 2 ),
		MONSTERS_SLAIN_4( "250 hypnotoads slain", 3 ),
		...
		NO_MONSTERS_SLAIN( "Level completed without killing any monsters, unlocked theme 'Pepsi!'", 28 ),
	...
	public static void validateBossSlain() {
		...
		case 5:
			...
			Theme.bull2 = true;
			ThemeScene.bundle.put(ThemeLoader.themerec2, Theme.bull2);
			break;
		case 10:
	...
	public static void validateNoKilling() {
		if (!local.contains( Badge.NO_MONSTERS_SLAIN ) && Statistics.completedWithNoKilling) {
			...
			ThemeScene.bundle.put(ThemeLoader.themerec1, Theme.bull);
			displayBadge( badge );
		}
	}
