...
import com.tsh.kurwapixedungeon.actors.buffs.Amok;
import com.tsh.kurwapixedungeon.actors.buffs.Light;
import com.tsh.kurwapixedungeon.actors.buffs.Rage;
import com.tsh.kurwapixedungeon.actors.hero.Hero;
import com.tsh.kurwapixedungeon.actors.hero.HeroClass;
import com.tsh.kurwapixedungeon.actors.mobs.npcs.Blacksmith;
import com.tsh.kurwapixedungeon.actors.mobs.npcs.Ghost;
import com.tsh.kurwapixedungeon.actors.mobs.npcs.Imp;
import com.tsh.kurwapixedungeon.actors.mobs.npcs.Wandmaker;
import com.tsh.kurwapixedungeon.actors.mobs.npcs.Weaponer;
...
import com.tsh.kurwapixedungeon.levels.CavesBossLevel;
import com.tsh.kurwapixedungeon.levels.CavesLevel;
import com.tsh.kurwapixedungeon.levels.CityBossLevel;
import com.tsh.kurwapixedungeon.levels.CityLevel;
import com.tsh.kurwapixedungeon.levels.DeadEndLevel;
import com.tsh.kurwapixedungeon.levels.HallsBossLevel;
import com.tsh.kurwapixedungeon.levels.HallsLevel;
import com.tsh.kurwapixedungeon.levels.HitlerLevel;
import com.tsh.kurwapixedungeon.levels.LastLevel;
import com.tsh.kurwapixedungeon.levels.LastShopLevel;
import com.tsh.kurwapixedungeon.levels.Level;
import com.tsh.kurwapixedungeon.levels.PrisonBossLevel;
import com.tsh.kurwapixedungeon.levels.PrisonLevel;
import com.tsh.kurwapixedungeon.levels.Room;
import com.tsh.kurwapixedungeon.levels.SewerBossLevel;
import com.tsh.kurwapixedungeon.levels.SewerLevel;
import com.tsh.kurwapixedungeon.scenes.GameScene;
import com.tsh.kurwapixedungeon.scenes.StartScene;
...
public class Dungeon {
	...
	public static void init() {
		...
		challenges = KurwaDungeon.challenges();
	...
	public static boolean bossLevel( int depth ) {
		return depth == 5 || depth == 10 || depth == 15 || depth == 20 || depth == 25 || depth == 32;
	}
	...
	public static void saveGame( String fileName ) throws IOException {
		try {
			...
			Weaponer		.Quest.storeInBundle( quests );
	...
	public static void loadGame( String fileName, boolean fullLoad ) throws IOException {
		...
		if (fullLoad) {
			...
			if (!quests.isNull()) {
				...
				Weaponer.Quest.restoreFromBundle( quests );
