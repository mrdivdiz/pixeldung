...
public class ChallengeScene extends PixelScene {

	private static final String TXT = 
		"This feature is under development\n" +
		"\n\n" + 
		"Please try to update game or " +
		"wait :)";
	...
	public void create() {
		...
		//GuideboardItem GUIDE_ARMOR = new GuideboardItem( "Evil army", 5 ) {
			//@Override
