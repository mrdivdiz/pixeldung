...
import com.tsh.kurwapixedungeon.effects.BannerSprites.Type;
...
import com.tsh.kurwapixedungeon.windows.WndClass;
...
public class StartScene extends PixelScene {
	...
	public void create() {
		...
		curClass = null;
		updateClass( HeroClass.values()[KurwaDungeon.lastClass()] );
	...
	private class ChallengeButton extends Button {
		...
		protected void onClick() {
			if (Badges.isUnlocked( Badges.Badge.VICTORY )) {
				StartScene.this.add( new WndChallenges( KurwaDungeon.challenges(), true ) {
