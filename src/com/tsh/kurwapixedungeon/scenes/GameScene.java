...
import com.tsh.kurwapixedungeon.DungeonTilemap;
import com.tsh.kurwapixedungeon.FogOfWar;
...
import com.tsh.kurwapixedungeon.effects.EmoIcon;
import com.tsh.kurwapixedungeon.effects.Flare;
import com.tsh.kurwapixedungeon.effects.FloatingText;
import com.tsh.kurwapixedungeon.effects.Ripple;
...
import com.tsh.kurwapixedungeon.plants.Plant;
import com.tsh.kurwapixedungeon.sprites.CharSprite;
import com.tsh.kurwapixedungeon.sprites.DiscardedItemSprite;
import com.tsh.kurwapixedungeon.sprites.HeroSprite;
import com.tsh.kurwapixedungeon.sprites.ItemSprite;
import com.tsh.kurwapixedungeon.sprites.PlantSprite;
import com.tsh.kurwapixedungeon.ui.AttackIndicator;
import com.tsh.kurwapixedungeon.ui.Banner;
import com.tsh.kurwapixedungeon.ui.BusyIndicator;
import com.tsh.kurwapixedungeon.ui.GameLog;
import com.tsh.kurwapixedungeon.ui.HealthIndicator;
import com.tsh.kurwapixedungeon.ui.ManaIndicator;
import com.tsh.kurwapixedungeon.ui.QuickSlot;
import com.tsh.kurwapixedungeon.ui.StatusPane;
import com.tsh.kurwapixedungeon.ui.Toast;
import com.tsh.kurwapixedungeon.ui.Toolbar;
import com.tsh.kurwapixedungeon.ui.Window;
import com.tsh.kurwapixedungeon.utils.GLog;
import com.tsh.kurwapixedungeon.windows.WndBag;
import com.tsh.kurwapixedungeon.windows.WndGame;
import com.tsh.kurwapixedungeon.windows.WndStory;
import com.tsh.kurwapixedungeon.windows.WndBag.Mode;
...
public class GameScene extends PixelScene {
	...
	private static final String TXT_WELCOME			= "Welcome to the level %d of Kurrwa PD!";
	private static final String TXT_WELCOME_BACK	= "Welcome back to the level %d of Kurrwa PD!";
	private static final String TXT_NIGHT_MODE		= "You're playing at nighttime?Lol it's more dangerous!!";
	...
	public void create() {
		...
		KurwaDungeon.lastClass( Dungeon.hero.heroClass.ordinal() );
		
		super.create();
		Camera.main.zoom( defaultZoom + KurwaDungeon.zoom() );
		...
		brightness( KurwaDungeon.brightness() );
