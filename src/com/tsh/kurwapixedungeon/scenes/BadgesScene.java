...
import com.tsh.kurwapixedungeon.effects.BadgeBanner;
...
import com.tsh.kurwapixedungeon.windows.WndBadge;
...
public class BadgesScene extends PixelScene {
	...
	public void create() {
		...
		int pw = (int)Math.min( w, (KurwaDungeon.landscape() ? MIN_WIDTH_L : MIN_WIDTH_P) * 3 ) - 16;
		int ph = (int)Math.min( h, (KurwaDungeon.landscape() ? MIN_HEIGHT_L : MIN_HEIGHT_P) * 3 ) - 32;
