...
import com.tsh.kurwapixedungeon.windows.WndError;
import com.tsh.kurwapixedungeon.windows.WndRanking;
...
public class RankingsScene extends PixelScene {
	...
	public void create() {
		...
		if (Rankings.INSTANCE.records.size() > 0) {
			...
			float rowHeight = KurwaDungeon.landscape() ? ROW_HEIGHT_L : ROW_HEIGHT_P;
