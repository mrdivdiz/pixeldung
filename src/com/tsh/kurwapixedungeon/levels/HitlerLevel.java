...
public class HitlerLevel extends RegularLevel {
	...
	public String tilesTex() {
		return Assets.TILES_HITLER;
	}
	
	@Override
	public String waterTex() {
		return Assets.WATER_HITLER;
	}
	...
	public String tileDesc(int tile) {
		...
		case Terrain.BOOKSHELF:
			return "The bookshelf is packed with cheap porn.Pages covered with cunt!";
		default:
