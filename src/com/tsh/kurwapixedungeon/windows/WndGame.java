...
import com.tsh.kurwapixedungeon.scenes.RankingsScene;
...
public class WndGame extends Window {
	...
	private static final String TXT_RETURN		= "Continue";
	...
	public WndGame() {
		...
		if (!Dungeon.hero.isAlive()) {
			...
			addButton( btnStart = new RedButton( TXT_START ) {
				...
				protected void onClick() {
					Dungeon.hero = null;
					KurwaDungeon.challenges( Dungeon.challenges );
	...
	public void addButton( RedButton btn ) {
		add( btn );
