...
import com.tsh.kurwapixedungeon.windows.WndTabbed;
...
import com.tsh.kurwapixedungeon.windows.WndTabbed.LabeledTab;
import com.tsh.kurwapixedungeon.windows.WndTabbed.Tab;
...
public class WndGuide extends Window {

	private static final int WIDTH		= 112;
	private static final int BTN_HEIGHT	= 20;
	private ScrollPane list;
	private RedButton inf;
	public String infotext = "Game scene will be closed, \n new scene will be opened";
	public WndGuide() {

		super( 112, 112, Chrome.get(Chrome.Type.WINDOW));
		
		HighlightedText text1 = new HighlightedText( 8 );
		text1.text( infotext, width);
		text1.setPos( 0, 0);
		add( text1 );
		HighlightedText text2 = new HighlightedText( 8 );
		text2.text( "Are you sure?", width);
		text2.setPos( BTN_HEIGHT / 2 + 23, 60);
		add( text2 );
		
		inf = new RedButton( "Sure" ){
			@Override
		...
		inf.setRect( 0, 90, WIDTH / 2 , BTN_HEIGHT);
	add(inf);
