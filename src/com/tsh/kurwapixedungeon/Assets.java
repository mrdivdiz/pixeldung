...
public class Assets {
	...
	public static String       ARCS_SPC 		= "specarch.png";
	public static String       ARCS_BG			= "arcs1.png";
	public static String 	   ARCS_FG			= "arcs2.png";
	public static final String DASHBOARD		= "dashboard.png";
	public static final String GUIDEBOARD		= "guideboard.png";
	public static final String HARDER_RAT  		= "rat2.png";
	
	public static final String G1				= "g1.png";
	public static final String G2				= "g2.png";
	public static final String G3				= "g3.png";
	
	
	public static final String BANNERS			= "banners.png";
	public static final String PRESENTING		= "presenting_ready.png";
	public static final String PRESENTING2		= "presenting2.png";
	public static final String STORE			= "story.png";
	public static final String RELIC			= "relics.png";
	...
	public static String 	   STANDARTTHEM		= "standartthem.png";
	public static final String STANDARTTHEM2	= "standartthem2.png";
	public static String 	   CHROME			= "chrome.png";
	public static final String ICONS			= "icons.png";
	public static String 	   STATUS			= "status_pane.png";
	public static final String HP_BAR			= "hp_bar.png";
	public static final String MANA_BAR			= "mana_bar.png";
	public static final String XP_BAR			= "exp_bar.png";
	public static String 	   TOOLBAR			= "toolbar.png";
	...
	public static final String ZASH				= "zashkvar.png";
	public static final String ROBT				= "robt.png";
	public static final String ANGRYROBT		= "robt.png";
	...
	public static String ITEMS					= "items.png";
	public static String ITEMS2					= "items3.png";
	public static final String PLANTS			= "plants.png";
	
	public static  String TILES_SEWERS			= "tiles0.png";
	public static final String TILES_HITLER		= "tiles5.png";
	public static final String TILES_BASE		= "tiles6.png";
	public static  String TILES_PRISON			= "tiles1.png";
	public static String TILES_CAVES			= "tiles2.png";
	public static  String TILES_CITY			= "tiles3.png";
	public static  String TILES_HALLS			= "tiles4.png";
	
	public static final String WATER_SEWERS		= "water0.png";
	public static final String WATER_HITLER		= "water5.png";
	...
	public static String THEME					= "theme.mp3";
	public static String TUNE     				= "game.mp3";
	public static final String HAPPY			= "surface.mp3";
	
	public static String SND_CLICK				= "snd_click.mp3";
	public static final String SND_BADGE		= "snd_badge.mp3";
	public static String SND_GOLD				= "snd_gold.mp3";
	
	public static final String SND_OPEN			= "snd_door_open.mp3";
	public static final String SND_UNLOCK		= "snd_unlock.mp3";
	public static String SND_ITEM				= "snd_item.mp3";
	public static final String SND_DEWDROP		= "snd_dewdrop.mp3";
	public static String SND_HIT				= "snd_hit.mp3";
	public static String 	   SND_SHOOT		= "ohohoh.mp3";
	...
	public static final String SND_WEED			= "snd_weed.mp3";
