...
import com.tsh.kurwapixedungeon.actors.mobs.Mimic;
...
import com.tsh.kurwapixedungeon.sprites.AdditionalItemSprite;
...
import com.tsh.kurwapixedungeon.windows.WndStuli;
...
public class Heap implements Bundlable {
	...
	public int image() {
		...
		case CHAIRS1:
			return AdditionalItems.CHAIR1;
		case CHAIRS2:
			return AdditionalItems.CHAIR2;
		default:
			return 0;
		}
	}
	...
	public AdditionalItemSprite.Glowing glowings() {
		return (type == Type.HEAP || type == Type.FOR_SALE) && items.size() > 0 ? items.peek().glowings() : null;
	}
