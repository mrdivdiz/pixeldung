...
abstract public class ShootingWeapon extends Weapon {

	private static final String TXT_MISSILES	= "Shooting weapon";
		...
		GameScene.show( 
			new WndOptions( TXT_MISSILES, TXT_R_U_SURE, TXT_YES, TXT_NO ) {
				...
				protected void onSelect(int index) {
					if (index == 0) {
						ShootingWeapon.super.doEquip( hero );
					}
				};
			}
		);
