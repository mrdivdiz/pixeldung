...
public class PPSH extends ShootingWeapon {

	{
		name = "ppsh";
		image = AdditionalItems.PPSH;
	...
	public String desc() {
		return 
			"PPSH(Pistolet-pulemet Shpagina - Pistol-machingegun of Shpagin).";
	}
}
